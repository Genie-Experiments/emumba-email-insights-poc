export const QUESTIONS = [
  {
    ...
    subQuestions: [
      {
        value: "sub1",
        label: "What were the offering from emumba for PWC?",
        tags: [
      ...
      {
        value: "sub3",
        label: "How did emumba offering specifically address PWC's needs?",
        tags: [
      ...
      {
        value: "sub4",
        label: "In what ways did emumba solution outperform competitors?",
        tags: [
          { value: "decision-criteria", label: "Decision Criteria" },
    ...
    subQuestions: [
      {
        value: "sub1",
        label:
          "What was emumba value proposition that specifically adressed PWC's challenges?",
        tags: [
          { value: "identified-pain", label: "Identified Pain" },
          { value: "decision-criteria", label: "Decision Criteria" },
        ],
      ...
      {
        value: "sub3",
        label: "How did emumba solve the problems PWC was facing?",
        tags: [
          { value: "metrics", label: "Metrics" },
          { value: "identified-pain", label: "Identified Pain" },
        ],
      ...
      {
        value: "sub4",
        label: "What were the use cases provided to emumba by PWC?",
        tags: [
          { value: "decision-process", label: "Decision Process" },
          { value: "decision-criteria", label: "Decision Criteria" },
        ],
  ...
  },
  {
    ...
    subQuestions: [
      ...
      },
      {
        value: "sub2",
        label:
          "What were PWC's business goals during the period when emumba engaged?",
        tags: [
          { value: "decision-criteria", label: "Decision Criteria" },
          { value: "economic-buyer", label: "Economic Buyer" },
        ],
